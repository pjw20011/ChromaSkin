...
public class FaceShapeController {
    ...
    // Python 스크립트 절대 경로
    private static final String FACE_PYTHON_SCRIPT_PATH = "C:/Users/abcit/Desktop/project/Demo_ver/Demo_ver/python-scripts/face-shape-classification.py"; // 실제 경로로 수정

    // 출력 이미지 저장 디렉토리 (외부 디렉토리)
    private static final String FACE_OUTPUT_DIR = "C:/Users/abcit/Desktop/project/Demo_ver/Demo_ver/output_images/"; // 실제 경로로 수정
    ...
    public String runFaceShapeAnalysis(
        ...
        try {
            ...
            processBuilder.directory(new File("C:/Users/abcit/Desktop/project/Demo_ver/Demo_ver/python-scripts/")); // 실제 경로로 수정
